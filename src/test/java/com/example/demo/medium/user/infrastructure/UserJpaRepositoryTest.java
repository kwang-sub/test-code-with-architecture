...
/*    @BeforeEach
    ...
    void findByEmailAndStatus_로_유저_데이터를_찾아올_수_있다() {
        ...
        // when
        Optional<UserEntity> result = userJpaRepository.findByEmailEqualsAndStatus("kwang@naver.com", UserStatus.ACTIVE);
        // then
    ...
    void findByEmailAndStatus_는_데이터가_없으면_Optional_empty_를_내려준다() {
        // given
        // when
        Optional<UserEntity> result = userJpaRepository.findByEmailEqualsAndStatus("kwang@naver.com", UserStatus.PENDING);
        // then
        assertThat(result).isEmpty();
    }
